...
public class tk2dSpriteAnimator : MonoBehaviour
{
    ...
    public int FrameIndex { get { return m_frameIndex; } private set { } }
    //帧图片的ID号
    private int m_frameId;
    public int FrameId { get { return m_frameId; } private set { } }
    //是否更改精灵图片
...
#region PlayFrom
	...
	{
        m_frameIndex = currFrame;
        m_frameId = currentClip.frames[currFrame].spriteId;
